...
def custom_label_encode(column):
    ...
    dump(label_dict, 'test/baggage_deployed_models/label_dict.joblib')
...
history = model1.fit(x_train, y_train,
        ...
        SaveWeights('C:/Users\Administrator\Desktop\Projects\member_pred/test/baggage_training_weights/model1/')], epochs=10000,
                     batch_size=50)
model1.save('test/baggage_deployed_models/baggage_model1.h5')
