...
def load_pred_pretrained_model(df_dict):
    df_future = pd.DataFrame(df_dict)
    df_future.rename(columns={'Is_holiday': 'is_holiday', 'Route': 'route', 'Departure': 'departure', 'PkFlightInformation': 'pkFlightInformation'}, inplace=True)
