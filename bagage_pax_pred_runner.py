import time
import schedule
from baggage_pax_pred_pretrained_model import baggage_pax_pred_pretrained_model
...
baggage_pax_pred_pretrained_model()
schedule.every(30).minutes.do(baggage_pax_pred_pretrained_model)
