...
x_train2 = x_train[(abs(y_pred_train1.reshape(-1)-y_train) >= 1.5)]
y_train2 = y_train[(abs(y_pred_train1.reshape(-1)-y_train) >= 1.5)]
# =====================================================================================================
...
model3.save('pax_deployed_models/pax_model3.h5')
model3.save_weights('pax_deployed_models/pax_model3_weights.h5')
